...
exports.readProducto = void 0;
var readProducto = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        ...
        if (event.httpMethod === 'GET' && event.resource === '/producto/{id}') {
            ...
            return [2 /*return*/, {
                    statusCode: 200,
                    body: JSON.stringify({ producto: { id: (_a = event.pathParameters) === null || _a === void 0 ? void 0 : _a.id, } }), // Aquí debes proporcionar los detalles del producto
                }];
        }
        return [2 /*return*/, {
                statusCode: 404,
